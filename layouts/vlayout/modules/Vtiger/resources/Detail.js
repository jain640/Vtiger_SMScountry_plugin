...
jQuery.Class("Vtiger_Detail_Js",{
	...
	/*
	Function to get response of check status in ajax.
	*/
	registerCheckStatusSmsEvent : function(){
        var thisInstance = this;
		jQuery('#SMSNotifier_detailView_moreAction_Check_Status a').on('click',function(e){
			e.preventDefault();
			...
			var SendSmsUrl = jQuery(this).attr('href');
	...
	registerEvents : function(){
		...
		this.registerCheckStatusSmsEvent();
