...
class SmsTemplates_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public static function getInstance($moduleName,$recordId) {
		...
		$moduleModel = SmsTemplates_Module_Model::getInstance($moduleName);
		$recordModel = SmsTemplates_Record_Model::getInstanceById($recordId, $moduleName);
