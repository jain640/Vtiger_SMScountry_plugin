...
class SmsTemplates_Record_Model extends Vtiger_Record_Model {
	 ...
	 * To get the fields from module, which has the sms field
	 * @return <arrray> template fields
	 */
	public function getSmsTemplateFields(){
		return $this->getModule()->getAllModuleSmsTemplateFields();
	}
	
	/**
	 * Function to get the Sms Template Record
	 * @param type $record
	 * @return <SmsTemplate_Record_Model>
	 */
	...
	public static function getInstanceById($templateId, $module=null) {
		...
		if($db->num_rows($result) > 0) {
			...
			return $recordModel->setData($row)->setModule('SmsTemplates');
		}
		return null;
	}
