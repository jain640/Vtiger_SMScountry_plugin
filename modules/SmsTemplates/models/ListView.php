...
class SmsTemplates_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewHeaders() {
		$fieldObjects = array();
		$listViewHeaders = array('Template Name' => 'templatename', 'Message' => 'message');
		foreach ($listViewHeaders as $key => $fieldName) {
			$fieldModel = new SmsTemplates_Field_Model();
	...
	function getQuery() {
		$listQuery = 'SELECT templateid, templatename, message FROM vtiger_smstemplates';
		return $listQuery;
	}
